...
const Cart = () => {
    ...
    const getinddata = async () => {
        const res = await fetch(`https://ecommerceapp-server-ecru.vercel.app/getproductsone/${id}`, {
            method: "GET",
            headers: {
    ...
    const addtocart = async (id)=>{
        // console.log(id);
        const check = await fetch(`https://ecommerceapp-server-ecru.vercel.app/addcart/${id}`, {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
